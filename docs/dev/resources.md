...
This document contains learning materials and references to help the team understand and build the system.

All resources listed here are curated by the **Lead Developer** and the **Research Team** of the project.

If you would like to suggest additional materials, please contact the Lead Developer so they can be reviewed and added to this document.

---

# Online Programming Resources

A curated collection of high-quality learning materials for programming, Git/GitHub, Java, and JavaFX.
