...
* Detects hand landmarks using camera input
* Tracks finger positions and movement
* Supports single and multi-hand detection

### 2. Gesture Recognition

* Identifies static and dynamic hand signs
* Maps gestures into predefined classes
...
Learn more about the development team behind this project by visiting our documentation page:

[About Us Page](/docs/dev/aboutus.md)
